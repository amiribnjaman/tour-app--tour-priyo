...
export default function Navbar() {
    ...
    return (
        <div className='w-[90%] mx-auto fixed top-[5px] md:left-[50px] z-50'>
            <nav class="border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
                    <div className='ml-9'>
                        <Link to='/' className='text-[#0E2385] text-xl font-semibold'>
                            CholoGuri
                        </Link>
                    </div>
                    <div class="flex items-center md:order-2 gap-x-1">
                        <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer  dark:hover:bg-gray-700 dark:hover:text-white">
                        ...
                        <div className='order-last'>
                            <button type="button" class="text-white bg-[#1C3C6B] hover:bg-blue-800 hover:shadow focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-[22px] py-[9px] mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign In</button>
                    ...
                    {/* <div class="items-center hidden justify-between w-full md:hidden md:w-auto md:order-1" id="mobile-menu-language-select">
