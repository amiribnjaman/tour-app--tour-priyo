                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto  p-4">
                    ...
                    <div class="flex items-center md:order-2 gap-x-2">
                        ...
                        <div>
                            ...
                            <button type="button" class="text-white bg-blue-800 hover:bg-blue-800 hover:shadow focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 mr-2 mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign In</button>
                            </div>
                        </div>
