      ...
      <nav class="  border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
          ...
          <div className="search-box w-full relative">
            <nav
              class="md:w-[45%] bg-white shadow shadow-[rgba(0,117,255,.0898711)] rounded-xl absolute -top-[60px] left-[27%] items-center hidden justify-between w-full md:flex md:order-2"
            ...
            >
              <ul class="flex items-center mx-auto flex-col font-medium py-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row  md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li className="">
                  <Link
                    to="/?search=flight"
                    className='flex items-center gap-x-2 py-5 px-6 text-black md:bg-transparent md:dark:text-blue-500'
                    aria-current="page"
                  >
          ...
          <div class="flex items-center md:order-2 gap-x-1">
            ...
            <div className="order-last">
              <button
                type="button"
                class="text-white bg-[#1C3C6B] hover:bg-blue-800 hover:shadow focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-[22px] py-[9px] mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                Sign In
              </button>
            </div>
